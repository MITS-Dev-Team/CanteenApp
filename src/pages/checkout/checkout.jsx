...
import { MdOutlinePayment } from "react-icons/md";import chickenBiriyaniImage from "../../static/food_images/biriyani.png";
                    ...
                    return (
                        ...
                        <div className=" mt-10 self-center">
                            <div className="flex flex-col justify-between items-left m-2 w-[90%] ">
                                ...
                                <span className="text-lg poppins-regular">Quantity : {item.count}</span>
                            </div>
  ...
  const handlePayment = useCallback(async () => {
    ...
    const options = {
      ...
      handler: async (response) => {
        ...
        const paymentResponse = await axios.post(`${backendUrl}/capture`, {
          paymentId,
          signature,
          orderId
        },
